...
Libraries:
    ...
    * GLFW 3.4
    * GLM 1.0.3
    * libjpeg-turbo 3.1.3 (with jpegtran)
    * libogg 1.3.6
    * libpng 1.6.53
    * libvorbis 1.3.7
    * SDL 2.32.10
...
[HISTORY]
20.0 - 2026-01-01 - GCC 15.2.0 - Boost 1.90.0 - Removed: grep, LAME, PCRE2. Updated: binutils 2.45.1, Boost 1.90.0,
    FreeType 2.14.1, GCC 15.2.0, gdb 17.1, glbinding 3.5.0, GLFW 3.4, GLM 1.0.3, libjpeg-turbo 3.1.3, libogg 1.3.6,
    libpng 1.6.53, OptiPNG 7.9.1, pngcheck 4.0.1, ripgrep 15.1.0, SDL 2.32.10, SDL_mixer 2.8.1, uutils/coreutils 0.5.0,
    vorbis-tools 1.4.3, zlib 1.3.1, zstd 1.5.7.
